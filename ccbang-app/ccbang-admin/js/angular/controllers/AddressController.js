...
addressCtrl.controller('AddrListCtrl', ['$scope','$http', function($scope,$http) {
	$http.get("/ssiframe/test/list")
    .success(function(response) {$scope.addresses = response;});
}]);

addressCtrl.controller('AddrDetailCtrl', ['$scope','$http','$routeParams', function($scope,$http,$routeParams) {
